    ...
    <div className='row'>
        <div className='col-sm-12 col-md-8 col-lg-10'>
          ...
          <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <Link to={"/bookings"} className="text-center btn btn-outline-dark mb-2 fw-bold ">Book For Rent/Day </Link>
                <Link to={"/bookings"} className="text-center btn btn-outline-dark mb-2  fw-bold ">Book For Rent/Month </Link>
